...
import com.portfolio.rosalucciarini.Dto.dtoEducacion;
import com.portfolio.rosalucciarini.Entidad.Educacion;
import com.portfolio.rosalucciarini.Security.Controller.Mensaje;
import com.portfolio.rosalucciarini.Servidor.ServEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion) {
        ...
        if (servEducacion.existsByNombrE(dtoeducacion.getNombrE())) {
            return new ResponseEntity(new Mensaje("Ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        }

        Educacion educacion = new Educacion(
                dtoeducacion.getNombrE(), dtoeducacion.getDescripcionE()
        );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion) {
        ...
        if (servEducacion.existsByNombrE(dtoeducacion.getNombrE()) && servEducacion.getByNombrE(dtoeducacion.getNombrE()).get().getId() != id) {
            return new ResponseEntity(new Mensaje("Ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        }
        if (StringUtils.isBlank(dtoeducacion.getNombrE())) {
