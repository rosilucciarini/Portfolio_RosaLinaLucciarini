...
public class ContExperiencia {
   ...
   public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){      
        ...
        if(servExperiencia.existsByNombrE(dtoexp.getNombrE()))
            return new ResponseEntity(new Mensaje("Esa experiencia existe"), HttpStatus.BAD_REQUEST);
        
        Experiencia experiencia = new Experiencia(dtoexp.getNombrE(), dtoexp.getDescripcionE());
   ...
   public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
       ...
       if(servExperiencia.existsByNombrE(dtoexp.getNombrE())&& servExperiencia.getByNombrE(dtoexp.getNombrE()).get().getId()!=id)
